...
#{
	...
	foreach($plugins as $plugin)
	{
		...
		$query = 'SELECT `id`' .
      ' FROM `#__extensions`' .
      ' WHERE type=\'plugin\' AND folder = '.$db->Quote($pgroup) .
...
<table class="adminlist">
	...
	<tbody>
		<tr class="row0">
			...
			<td><img src="templates/bluestork/images/admin/publish_g.png" alt="OK" /> <strong>Installed</strong></td>
		</tr>
		...
		<tr class="row<?php echo (++ $rows % 2); ?>">
			...
			<td><img src="templates/bluestork/images/admin/publish_g.png" alt="OK" /> <strong><?php echo JText::_('Installed'); ?></strong></td>
		</tr>
		<?php }
		}
