...
<h2>Next Steps</h2>
<p>
<ul><li>Create a <a href="index.php?option=com_menus&task=edit&type=component&url[option]=com_suggestvotecommentbribe&url[view]=suggs&menutype=mainmenu">menu item from the "<?php JText::_('COMPONENT_TITLE')?> &rArr; Suggs &rArr; Default Layout"</a>
<li>Update <a href="index.php?option=com_suggestvotecommentbribe&view=suggestions"><i><?php JText::_('COMPONENT_TITLE') ?></i> settings</a></li>
</ul>
</p>
