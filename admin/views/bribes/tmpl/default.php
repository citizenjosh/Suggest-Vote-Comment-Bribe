...
<div id="tablecell">
   ...
   <thead>
      <tr>
         <th class="subject" style="text-align:left;">
            <?php echo JHTML::_('grid.sort',   'Suggestion', 'title', $this->lists['order_Dir'], $this->lists['order'] ); ?>
         </th>
            <th  style="text-align:left;">
      <?php echo JHTML::_('grid.sort', 'Amount', 'amount', $this->lists['order_Dir'], $this->lists['order']);?>
   </th>
      </tr>
   </thead>
