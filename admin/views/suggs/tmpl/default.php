...
<div id="tablecell">
   ...
   <thead>
      ...
      <?php echo JHTML::_('grid.sort', 'description', 'description', $this->lists['order_Dir'], $this->lists['order']);?>
            ...
            <th style="text-align:left;">
            <?php echo JHTML::_('grid.sort', '# of votes', 'noofVotes', $this->lists['order_Dir'], $this->lists['order']);?>
         </th>
            <th style="text-align:left;">
            <?php echo JHTML::_('grid.sort', '# of comments', 'noofComs', $this->lists['order_Dir'], $this->lists['order']);?>
         </th>
         <th style="text-align:left;">
            <?php echo JHTML::_('grid.sort', 'Amount Bribed', 'amountDonated', $this->lists['order_Dir'], $this->lists['order']);?>
         </th>
   ...
   ?>
      <tr class="<?php echo "row$k"; ?>">
         ...
         <td>
            <span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit sugg' );?>::<?php echo $row->title; ?>">
   ...
   <td><?php          
       ...
       ?></td>
               ...
               ?>
                  <a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','<?php echo $row->state ? "Open" : "Close";?>');">
