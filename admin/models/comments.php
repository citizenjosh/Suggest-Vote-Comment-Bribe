...
class SuggestionsModelcomments extends JModel
{
	...
	function __construct()
	{
		...
		$this->filter_order_Dir = $app->getUserStateFromRequest( $option.'com.filter_order_Dir', 'filter_order_Dir', '', 'word' );
		$this->filter_order  = $app->getUserStateFromRequest( $option.'com.filter_order', 'filter_order',  'ordering', 'cmd' );
		$this->filter_order  = $app->getUserStateFromRequest( $option.'com.filter_order', 'filter_order',  'ordering', 'cmd' );
		...
		$limitstart = $app->getUserStateFromRequest( $option.'com.limitstart', 'limitstart', 0, 'int' );
